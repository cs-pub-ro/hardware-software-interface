...
function initSearch() {
  ...
  request.open('GET', '/hardware-software-interface/166/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/hardware-software-interface/166/assets/css/just-the-docs-' + theme + '.css');
}
